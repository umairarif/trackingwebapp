    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content">
                ...
                <form role="form" id="updateform" method="post" action="<?php echo base_url();?>/index.php/admin/operations/additems">
				  <div class="form-group">
					...
					<div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" name="cphone">
