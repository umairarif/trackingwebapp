    ...
    <div class="box col-md-12">
        <div class="box-inner">
			...
			<?php foreach($edata as $value): ?>
                <form role="form" id="updateform" method="post" action="<?php echo base_url();?>/index.php/admin/operations/updateorder/<?php echo $value['id']?>">
				  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter email" name="cemail" value="<?php echo $value['email']?>">
                    </div>
					<div class="form-group">
                        <label for="exampleInputEmail1">Phone</label>
                        <input type="text" class="form-control" id="exampleInputName1" name="cphone" value="<?php echo $value['phone']?>">
                    </div>
					<div class="form-group">
                        <label for="exampleInputEmail1">Address</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="caddress" value="<?php echo $value['address']?>">
                    </div>
